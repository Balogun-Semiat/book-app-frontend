...
const CheckOut = () => {
    ...
    const totalPrice = cartItems.reduce((acc, items)=> acc + items.newPrice, 0).toFixed(2);
  ...
  return (
    ...
    <div className="container max-w-screen-lg mx-auto">
        <div>
            ...
            <p className="text-gray-500 mb-6">{cartItems.length > 0 ? cartItems.length : 0}</p>
            </div>
                            ...
                            <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                <div className="md:col-span-5">
                                    ...
                                    <input
                                        ...
                                        className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" {...register("name", { required: true })} />
                                </div>
