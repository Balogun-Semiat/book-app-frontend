...
const Banner = () => {
  return (
   <div className='flex flex-col md:flex-row-reverse bg-red-200 justify-center items-center gap-12 md:p-16 p-5'>
    <div className='w-1/2 w-full flex items-center md:justify-end'>
        <img src={banner} alt="" />
    </div>
